...
import { Mail, Lock, User, Loader, ArrowRight, Banknote } from "lucide-react";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result?.ok) {
        ...
        setError("Account created but could not auto-sign in. Please try signing in manually.");
        setLoading(false);
      }
    } catch (err) {
      ...
      <div style={S.container}>
        ...
        <div style={{ marginBottom: 30 }}>
          ...
          <p style={{ fontSize: 14, color: "#666" }}>
            ...
            <a href="/auth/signin" style={{ color: "#6366F1", fontWeight: 600, textDecoration: "none" }}>
              Sign in
            </a>
          </p>
        </div>
        ...
        {/* Google sign up */}
        <button type="button" onClick={handleGoogleSignUp} disabled={loading} style={{ ...S.googleBtn, opacity: loading ? 0.7 : 1, cursor: loading ? "not-allowed" : "pointer" }}>
        ...
        {/* Terms */}
        <p style={{ marginTop: 20, fontSize: 12, color: "#999", textAlign: "center", lineHeight: 1.6 }}>
